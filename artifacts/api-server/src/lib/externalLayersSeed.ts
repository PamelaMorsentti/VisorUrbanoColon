...
export const externalLayerSeed: InsertLayerCatalog[] = [
  ...
  },
  {
    ...
    layerType: "wms",
    sourceUrl: "https://geoservicios.conae.gov.ar/geoserver/GeoServiciosCONAE/wms",
    sourceLayerName: "FocosDeCalorVIIRS",
    attribution:
      '&copy; <a href="https://catalogos.conae.gov.ar" target="_blank">CONAE</a>',
    isExternal: true,
    isActive: true,
    supportsGetFeatureInfo: true,
    legend: [
  ...
  },
  {
    ...
    layerType: "wms",
    sourceUrl: "https://geoservicios2.conae.gov.ar/geoserver/HumedadDeSuelos/wms",
    sourceLayerName: "SMAP_Pasada_Ascendente",
    attribution:
      '&copy; <a href="https://catalogos.conae.gov.ar" target="_blank">CONAE</a>',
    isExternal: true,
    isActive: true,
  ...
  {
    key: "ext_conae_combustible_l89",
    label: "CONAE — Combustible L89",
    description: "Disponibilidad de combustible derivada de Landsat 8/9 (SIAR-TIV)",
    group: "Riesgo e incendios",
    layerType: "wms",
    sourceUrl: "https://geoservicios.conae.gov.ar/geoserver/AlertaTemprana/wms",
    sourceLayerName: "INC_SIARTIVGEOL89_DC_1",
    attribution:
      '&copy; <a href="https://catalogos.conae.gov.ar" target="_blank">CONAE</a>',
    isExternal: true,
    isActive: true,
