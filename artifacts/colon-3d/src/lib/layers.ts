...
export const LAYERS: LayerDef[] = [
  ...
  },
  {
    ...
    defaultVisible: false,
    group: "Catastro",
    description: "Agrupación de parcelas en grupos",
    labelZoom: 15,
  },
  {
    id: "barrios",
  ...
  },
  {
    ...
    defaultVisible: false,
    group: "Topografía",
    description: "Curvas de nivel (c_nivel.shp — solo geometría, sin atributos)",
  },
  {
    id: "edif",
    label: "Edificios (PB)",
  ...
  },
  {
    ...
    defaultVisible: false,
    group: "Edificios",
    description: "Plantas de techo y cubiertas (ph.shp)",
    lazy: true,
  },
  {
    id: "arbol",
