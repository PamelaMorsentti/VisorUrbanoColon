...
export const EXTERNAL_LAYERS: ExternalLayerDef[] = [
  ...
  // ── Registros IDE Entre Ríos (mapa 343) ──────────────────────────────
  {
    id: "ext_ideer_corufa_registro",
    label: "IDEER/CORUFA — Registro de CORUFA",
    description: "Registros obrantes en la Dirección CORUFA (IDE Entre Ríos · mapa 343)",
    type: "wms",
    url: "https://geoservicios.entrerios.gov.ar/geoserver/ows",
    wmsLayers: "geonode:registro_de_corufa",
    wmsFormat: "image/png",
    wmsTransparent: true,
    attribution: '&copy; <a href="https://geoservicios.entrerios.gov.ar" target="_blank">IDE Entre Ríos</a> · CORUFA',
    color: "#38bdf8",
    opacity: 0.75,
  ...
  {
    id: "ext_ideer_perforistas_registro",
    label: "IDEER/CORUFA — Registro de perforistas",
    description: "Registro de perforistas en Entre Ríos (IDE Entre Ríos · mapa 343)",
    type: "wms",
    url: "https://geoservicios.entrerios.gov.ar/geoserver/ows",
    wmsLayers: "geonode:registro_de_perforistas",
    wmsFormat: "image/png",
    wmsTransparent: true,
    attribution: '&copy; <a href="https://geoservicios.entrerios.gov.ar" target="_blank">IDE Entre Ríos</a> · CORUFA',
    color: "#f97316",
  ...
  {
    id: "ext_ideer_laboratorios_registro",
    label: "IDEER/CORUFA — Registro de laboratorios",
    description: "Registro de laboratorios vinculados al recurso hídrico (IDE Entre Ríos · mapa 343)",
    type: "wms",
    url: "https://geoservicios.entrerios.gov.ar/geoserver/ows",
    wmsLayers: "geonode:registro_de_laboratorios",
    wmsFormat: "image/png",
    wmsTransparent: true,
    attribution: '&copy; <a href="https://geoservicios.entrerios.gov.ar" target="_blank">IDE Entre Ríos</a> · CORUFA',
    color: "#ef4444",
  ...
  {
    id: "ext_ideer_perforaciones_cfi",
    label: "IDEER/CFI — Perforaciones relevadas",
    description: "Perforaciones relevadas por consultoría CFI (IDE Entre Ríos · mapa 343)",
    type: "wms",
    url: "https://geoservicios.entrerios.gov.ar/geoserver/ows",
    wmsLayers: "geonode:cfi___santi___bianchi",
    wmsFormat: "image/png",
    wmsTransparent: true,
    attribution: '&copy; <a href="https://geoservicios.entrerios.gov.ar" target="_blank">IDE Entre Ríos</a> · CFI',
    color: "#22c55e",
    opacity: 0.75,
    group: "Registros IDE Entre Ríos",
    supportsGetFeatureInfo: true,
