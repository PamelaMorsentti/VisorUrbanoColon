...
> = {
  ...
  ext_conae_focos_viirs: { color: "#f97316", opacity: 0.8, wmsFormat: "image/png", wmsTransparent: true },
  ext_conae_focos_modis: { color: "#ef4444", opacity: 0.8, wmsFormat: "image/png", wmsTransparent: true },
  ext_conae_humedad_smap: { color: "#38bdf8", opacity: 0.75, wmsFormat: "image/png", wmsTransparent: true },
  ext_conae_combustible_l89: { color: "#a855f7", opacity: 0.75, wmsFormat: "image/png", wmsTransparent: true },
